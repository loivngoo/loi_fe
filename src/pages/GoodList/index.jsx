...
function GoodList() {
    ...
    const handleShowConfirm = (product, event) => {
        if (!event) return openNotification('success', 'Sản phẩm này không có sự kiện giảm giá');
        Modal.confirm({
            title: 'Confirm',
            content: 'Xác nhận mua sản phẩm với giá x đồng. Bạn sẽ nhận được y đồng khi sự kiện giảm giá kết thúc.',
            okText: 'Đồng ý',
            cancelText: 'Hủy',
            onOk() {
                confirmBuy(product);
